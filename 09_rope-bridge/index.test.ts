...
Deno.test("Day 09 - Part 1 - Example input", () => {
  assertEquals(13, solvePart1(exampleInput))
})

Deno.test("Day 09 - Part 1 - File input", () => {
  assertEquals(6090, solvePart1(fileInput))
})

Deno.test("Day 09 - Part 2 - Example input", () => {
  assertEquals(1, solvePart2(exampleInput, 10))
})

Deno.test("Day 09 - Part 2 - Example input 2", () => {
  assertEquals(36, solvePart2(exampleInput2, 10))
})

Deno.test("Day 09 - Part 2 - File input", () => {
